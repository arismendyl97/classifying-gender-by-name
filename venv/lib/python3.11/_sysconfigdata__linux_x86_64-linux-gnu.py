...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/workspaces/classifying-gender-by-name/venv/bin',
 'BINLIBDEST': '/workspaces/classifying-gender-by-name/venv/lib/python3.11',
 'BLDLIBRARY': 'libpython3.11.a',
 'BLDSHARED': 'gcc -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/workspaces/classifying-gender-by-name/venv/lib '
              '-Wl,-rpath-link,/workspaces/classifying-gender-by-name/venv/lib '
              '-L/workspaces/classifying-gender-by-name/venv/lib '
              ''
              ''
              '-Wl,-rpath,/workspaces/classifying-gender-by-name/venv/lib '
              '-Wl,-rpath-link,/workspaces/classifying-gender-by-name/venv/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-DNDEBUG -fwrapv -O2 -Wall   '
           '-fPIC   -O2 '
           '-isystem '
           '/workspaces/classifying-gender-by-name/venv/include '
           ''
           ''
           ''
           '-fPIC '
 ...
 'CONFIGURE_CPPFLAGS': '-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem '
                       '/workspaces/classifying-gender-by-name/venv/include '
                       '-I/workspaces/classifying-gender-by-name/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-rpath,/workspaces/classifying-gender-by-name/venv/lib '
                      '-Wl,-rpath-link,/workspaces/classifying-gender-by-name/venv/lib '
 ...
 'CONFIG_ARGS': "'--prefix=/workspaces/classifying-gender-by-name/venv'"
                "'--build=x86_64-conda_cos6-linux-gnu'"
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6'"
                "'--with-ensurepip=no'"
                "'--with-tzpath=/workspaces/classifying-gender-by-name/venv/share/zoneinfo:/workspaces/classifying-gender-by-name/venv/share/tzinfo'"
                "'--with-computed-gotos''--with-system-ffi'"
                "'--enable-loadable-sqlite-extensions'"
                "'--with-tcltk-includes=-I/workspaces/classifying-gender-by-name/venv/include'"
                "'--with-tcltk-libs=-L/workspaces/classifying-gender-by-name/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/workspaces/classifying-gender-by-name/venv/lib/pkgconfig'"
 ...
 'CONFINCLUDEDIR': '/workspaces/classifying-gender-by-name/venv/include',
 'CONFINCLUDEPY': '/workspaces/classifying-gender-by-name/venv/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/workspaces/classifying-gender-by-name/venv/include '
             '-I/workspaces/classifying-gender-by-name/venv/include',
 'CXX': 'g++ -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat',
 ...
 'DESTDIRS': '/workspaces/classifying-gender-by-name/venv '
             '/workspaces/classifying-gender-by-name/venv/lib '
             '/workspaces/classifying-gender-by-name/venv/lib/python3.11 '
             '/workspaces/classifying-gender-by-name/venv/lib/python3.11/lib-dynload',
 'DESTLIB': '/workspaces/classifying-gender-by-name/venv/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/workspaces/classifying-gender-by-name/venv/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/workspaces/classifying-gender-by-name/venv/include '
                   '/workspaces/classifying-gender-by-name/venv/include '
                   '/workspaces/classifying-gender-by-name/venv/include/python3.11 '
                   '/workspaces/classifying-gender-by-name/venv/include/python3.11',
 'INCLUDEDIR': '/workspaces/classifying-gender-by-name/venv/include',
 'INCLUDEPY': '/workspaces/classifying-gender-by-name/venv/include/python3.11',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/workspaces/classifying-gender-by-name/venv/lib '
            '-Wl,-rpath-link,/workspaces/classifying-gender-by-name/venv/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat -shared  '
             ''
             ''
             '-Wl,-rpath,/workspaces/classifying-gender-by-name/venv/lib '
             '-Wl,-rpath-link,/workspaces/classifying-gender-by-name/venv/lib '
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/workspaces/classifying-gender-by-name/venv/lib/python3.11',
 'LIBDIR': '/workspaces/classifying-gender-by-name/venv/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/workspaces/classifying-gender-by-name/venv/include',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/workspaces/classifying-gender-by-name/venv/lib/pkgconfig',
 'LIBPL': '/workspaces/classifying-gender-by-name/venv/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/workspaces/classifying-gender-by-name/venv/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /workspaces/classifying-gender-by-name/venv/compiler_compat',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/croot/python-split_1713544621630/work/Modules/makesetup',
 'MANDIR': '/workspaces/classifying-gender-by-name/venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/workspaces/classifying-gender-by-name/venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include',
 'MODULE__HASHLIB_DEPS': '/croot/python-split_1713544621630/work/Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                            '-ltk8.6 -ltkstub8.6 -ltcl8.6 -ltclstub8.6',
 'MODULE__TKINTER_STATE': 'yes',
 'MODULE__TRACEMALLOC_LDFLAGS': '',
 'MODULE__TYPING_STATE': 'yes',
 'MODULE__UUID_CFLAGS': '-I/workspaces/classifying-gender-by-name/venv/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib '
                         '-luuid',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/workspaces/classifying-gender-by-name/venv/include',
 'OPENSSL_LDFLAGS': '-L/workspaces/classifying-gender-by-name/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/workspaces/classifying-gender-by-name/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/workspaces/classifying-gender-by-name/venv/share/zoneinfo:/workspaces/classifying-gender-by-name/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './workspaces/classifying-gender-by-name/venv',
 'WASM_STDLIB': './workspaces/classifying-gender-by-name/venv/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/workspaces/classifying-gender-by-name/venv/share',
 'exec_prefix': '/workspaces/classifying-gender-by-name/venv',
 'prefix': '/workspaces/classifying-gender-by-name/venv',
